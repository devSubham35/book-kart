...
const RegisterUI = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gradient-to-b from-background to-muted p-8">
        ...
        <div className="flex flex-col items-center justify-center p-6">
          <div className="max-w-sm w-full">
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Please register to buy or sell your books.
              </p>
            </div>
            ...
            <Form {...form}>
              ...
              >
                ...
                <Button loading={isRegisterPending} type="submit" className="mt-2 w-full">
                  Continue
                </Button>
              </form>
            </Form>
